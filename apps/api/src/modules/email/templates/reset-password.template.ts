...
export function buildResetPasswordTemplate(
  ...
  const htmlInput = {
    ...
    resetLink: escapeHtml(input.resetLink),
  ...
  return {
    subject: "Reset your password - Median",
    html: `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
                    ...
                    <div style="box-sizing:border-box;height:100%;padding:0;">
                      ...
                      <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                        <tbody><tr><td style="padding:0 36px 28px;font-family:arial,helvetica,sans-serif;" align="center">
                          <a href="${htmlInput.resetLink}" style="display:inline-block;padding:14px 28px;background-color:#E8522A;color:#ffffff;font-size:15px;font-weight:bold;text-decoration:none;border-radius:6px;font-family:arial,helvetica,sans-serif;">Reset Password</a>
                        </td></tr></tbody>
                      </table>
                      <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
